...
class ReturnsSpec extends BaseSpec with Matchers {
  ...
  Feature("Submit ECL Return") {
    ...
    Scenario("User that is registered for ECL starts a return submission") {
      ...
      thenIShouldSeeMyEclReturnNumberIsXAndTheAmountToPayIsX("ECL return number", "Amount you need to pay")

    }

    Scenario(
      "Return submission for 12 month accounting period and AML-regulated activity for the full financial year [UK Revenue=10200000, Expected content=You need to pay £10,000]"
    ) {
      Given("I am signed in to the return journey")
      givenIAmSignedInToTheReturnJourney()

      When(
        "I enter 12 month accounting period revenue 10200000 and select Yes for my AML-regulated activity for the full financial year"
      )
      whenIEnter12MonthAccountingPeriodRevenueXAndSelectXForMyAMLregulatedActivityForTheFullFinancialYear(
        "10200000",
        "Yes"
      ...
      thenIShouldBeOnThePageThatSaysX("You need to pay £10,000")

    }

    Scenario(
      "Return submission for 12 month accounting period and AML-regulated activity for the full financial year [UK Revenue=35999999, Expected content=You need to pay £10,000]"
    ) {
      Given("I am signed in to the return journey")
      givenIAmSignedInToTheReturnJourney()

      When(
        "I enter 12 month accounting period revenue 35999999 and select Yes for my AML-regulated activity for the full financial year"
      )
      whenIEnter12MonthAccountingPeriodRevenueXAndSelectXForMyAMLregulatedActivityForTheFullFinancialYear(
        "35999999",
        "Yes"
    ...
    Scenario(
      "Return submission for 12 month accounting period and AML-regulated activity for the full financial year [UK Revenue=36000000, Expected content=You need to pay £36,000]"
    ) {
      Given("I am signed in to the return journey")
      givenIAmSignedInToTheReturnJourney()

      When(
        "I enter 12 month accounting period revenue 36000000 and select Yes for my AML-regulated activity for the full financial year"
      )
      whenIEnter12MonthAccountingPeriodRevenueXAndSelectXForMyAMLregulatedActivityForTheFullFinancialYear(
        "36000000",
        "Yes"
      ...
      thenIShouldBeOnThePageThatSaysX("You need to pay £36,000")

    }

    Scenario(
      "Return submission for 12 month accounting period and AML-regulated activity for the full financial year [UK Revenue=999999999, Expected content=You need to pay £36,000]"
    ) {
      Given("I am signed in to the return journey")
      givenIAmSignedInToTheReturnJourney()

      When(
        "I enter 12 month accounting period revenue 999999999 and select Yes for my AML-regulated activity for the full financial year"
      )
      whenIEnter12MonthAccountingPeriodRevenueXAndSelectXForMyAMLregulatedActivityForTheFullFinancialYear(
        "999999999",
        "Yes"
    ...
    Scenario(
      "Return submission for 12 month accounting period and AML-regulated activity for the full financial year [UK Revenue=1000000000, Expected content=You need to pay £500,000]"
    ) {
      Given("I am signed in to the return journey")
      givenIAmSignedInToTheReturnJourney()

      When(
        "I enter 12 month accounting period revenue 1000000000 and select Yes for my AML-regulated activity for the full financial year"
      )
      whenIEnter12MonthAccountingPeriodRevenueXAndSelectXForMyAMLregulatedActivityForTheFullFinancialYear(
        "1000000000",
        "Yes"
      ...
      thenIShouldBeOnThePageThatSaysX("You need to pay £500,000")

    }

    Scenario(
      "Return submission for 12 month accounting period and AML-regulated activity for the non-full financial year [UK Revenue=10200000, AMLDays=60, Expected content=You need to pay £1,643.83]"
    ) {
      Given("I am signed in to the return journey")
      givenIAmSignedInToTheReturnJourney()

      When(
        "I enter 12 month accounting period revenue 10200000 and select No for my AML-regulated activity for the full financial year"
      )
      whenIEnter12MonthAccountingPeriodRevenueXAndSelectXForMyAMLregulatedActivityForTheFullFinancialYear(
        "10200000",
        "No"
      ...
      andIEnterTheNumberOfDaysXICarriedOutAMLRegulatedActivityDuringTheFinancialYear("60")

      Then("I should be on the page that says You need to pay £1,643.83")
      thenIShouldBeOnThePageThatSaysX("You need to pay £1,643.83")

    }

    Scenario(
      "Return submission for 12 month accounting period and AML-regulated activity for the non-full financial year [UK Revenue=999999999, AMLDays=204, Expected content=You need to pay £20,120.54]"
    ) {
      Given("I am signed in to the return journey")
      givenIAmSignedInToTheReturnJourney()

      When(
        "I enter 12 month accounting period revenue 999999999 and select No for my AML-regulated activity for the full financial year"
      )
      whenIEnter12MonthAccountingPeriodRevenueXAndSelectXForMyAMLregulatedActivityForTheFullFinancialYear(
        "999999999",
        "No"
      ...
      andIEnterTheNumberOfDaysXICarriedOutAMLRegulatedActivityDuringTheFinancialYear("204")

      Then("I should be on the page that says You need to pay £20,120.54")
      thenIShouldBeOnThePageThatSaysX("You need to pay £20,120.54")

    }

    Scenario(
      "Return submission for 12 month accounting period and AML-regulated activity for the non-full financial year [UK Revenue=1000000000, AMLDays=330, Expected content=You need to pay £452,054.79]"
    ) {
      Given("I am signed in to the return journey")
      givenIAmSignedInToTheReturnJourney()

      When(
        "I enter 12 month accounting period revenue 1000000000 and select No for my AML-regulated activity for the full financial year"
      )
      whenIEnter12MonthAccountingPeriodRevenueXAndSelectXForMyAMLregulatedActivityForTheFullFinancialYear(
        "1000000000",
        "No"
      ...
      andIEnterTheNumberOfDaysXICarriedOutAMLRegulatedActivityDuringTheFinancialYear("330")

      Then("I should be on the page that says You need to pay £452,054.79")
      thenIShouldBeOnThePageThatSaysX("You need to pay £452,054.79")

    }

    Scenario(
      "Return submission for non 12 month accounting period and AML-regulated activity for the full financial year [UK Revenue=10000000, APDays=182, Expected content=You need to pay £10,000]"
    ) {
      Given("I am signed in to the return journey")
      givenIAmSignedInToTheReturnJourney()

      When("I select No for my accounting period 12 months and enter the length of my accounting period as 182 days")
      whenISelectXForMyAccountingPeriod12MonthsAndEnterTheLengthOfMyAccountingPeriodAsXDays("No", "182")

      And(
        "I enter my UK revenue 10000000 for the accounting period and select Yes for my AML-regulated activity for the full financial year"
      )
      whenIEnterMyUKRevenueXForTheAccountingPeriodAndSelectXForMyAMLregulatedActivityForTheFullFinancialYear(
        "10000000",
        "Yes"
    ...
    Scenario(
      "Return submission for non 12 month accounting period and AML-regulated activity for the full financial year [UK Revenue=8000000, APDays=73, Expected content=You need to pay £36,000]"
    ) {
      Given("I am signed in to the return journey")
      givenIAmSignedInToTheReturnJourney()

      When("I select No for my accounting period 12 months and enter the length of my accounting period as 73 days")
      whenISelectXForMyAccountingPeriod12MonthsAndEnterTheLengthOfMyAccountingPeriodAsXDays("No", "73")

      And(
        "I enter my UK revenue 8000000 for the accounting period and select Yes for my AML-regulated activity for the full financial year"
      )
      whenIEnterMyUKRevenueXForTheAccountingPeriodAndSelectXForMyAMLregulatedActivityForTheFullFinancialYear(
        "8000000",
        "Yes"
    ...
    Scenario(
      "Return submission for non 12 month accounting period and AML-regulated activity for the full financial year [UK Revenue=1300000000, APDays=450, Expected content=You need to pay £500,000]"
    ) {
      Given("I am signed in to the return journey")
      givenIAmSignedInToTheReturnJourney()

      When("I select No for my accounting period 12 months and enter the length of my accounting period as 450 days")
      whenISelectXForMyAccountingPeriod12MonthsAndEnterTheLengthOfMyAccountingPeriodAsXDays("No", "450")

      And(
        "I enter my UK revenue 1300000000 for the accounting period and select Yes for my AML-regulated activity for the full financial year"
      )
      whenIEnterMyUKRevenueXForTheAccountingPeriodAndSelectXForMyAMLregulatedActivityForTheFullFinancialYear(
        "1300000000",
        "Yes"
    ...
    Scenario(
      "Return submission for non 12 month accounting period and AML-regulated activity for the non-full financial year [UK Revenue=10000000, APDays=113, AMLDays=198, Expected content=You need to pay £5,424.65]"
    ) {
      Given("I am signed in to the return journey")
      givenIAmSignedInToTheReturnJourney()

      When("I select No for my accounting period 12 months and enter the length of my accounting period as 113 days")
      whenISelectXForMyAccountingPeriod12MonthsAndEnterTheLengthOfMyAccountingPeriodAsXDays("No", "113")

      And(
        "I enter my UK revenue 10000000 for the accounting period and select No for my AML-regulated activity for the full financial year"
      )
      whenIEnterMyUKRevenueXForTheAccountingPeriodAndSelectXForMyAMLregulatedActivityForTheFullFinancialYear(
        "10000000",
        "No"
      ...
      andIEnterTheNumberOfDaysXICarriedOutAMLRegulatedActivityDuringTheFinancialYear("198")

      Then("I should be on the page that says You need to pay £5,424.65")
      thenIShouldBeOnThePageThatSaysX("You need to pay £5,424.65")

    }

    Scenario(
      "Return submission for non 12 month accounting period and AML-regulated activity for the non-full financial year [UK Revenue=31000000, APDays=284, AMLDays=300, Expected content=You need to pay £29,589.04]"
    ) {
      Given("I am signed in to the return journey")
      givenIAmSignedInToTheReturnJourney()

      When("I select No for my accounting period 12 months and enter the length of my accounting period as 284 days")
      whenISelectXForMyAccountingPeriod12MonthsAndEnterTheLengthOfMyAccountingPeriodAsXDays("No", "284")

      And(
        "I enter my UK revenue 31000000 for the accounting period and select No for my AML-regulated activity for the full financial year"
      )
      whenIEnterMyUKRevenueXForTheAccountingPeriodAndSelectXForMyAMLregulatedActivityForTheFullFinancialYear(
        "31000000",
        "No"
      ...
      andIEnterTheNumberOfDaysXICarriedOutAMLRegulatedActivityDuringTheFinancialYear("300")

      Then("I should be on the page that says You need to pay £29,589.04")
      thenIShouldBeOnThePageThatSaysX("You need to pay £29,589.04")

    }

    Scenario(
      "Return submission for non 12 month accounting period and AML-regulated activity for the non-full financial year [UK Revenue=350000000, APDays=91, AMLDays=256, Expected content=You need to pay £350,684.93]"
    ) {
      Given("I am signed in to the return journey")
      givenIAmSignedInToTheReturnJourney()

      When("I select No for my accounting period 12 months and enter the length of my accounting period as 91 days")
      whenISelectXForMyAccountingPeriod12MonthsAndEnterTheLengthOfMyAccountingPeriodAsXDays("No", "91")

      And(
        "I enter my UK revenue 350000000 for the accounting period and select No for my AML-regulated activity for the full financial year"
      )
      whenIEnterMyUKRevenueXForTheAccountingPeriodAndSelectXForMyAMLregulatedActivityForTheFullFinancialYear(
        "350000000",
        "No"
      ...
      andIEnterTheNumberOfDaysXICarriedOutAMLRegulatedActivityDuringTheFinancialYear("256")

      Then("I should be on the page that says You need to pay £350,684.93")
      thenIShouldBeOnThePageThatSaysX("You need to pay £350,684.93")
    ...
    Scenario("User wants to change their ECL contact details before submitting the returns") {
      ...
      whenIClickOnTheChangeLinkToModifyMyContactDetails()
    ...
    Scenario("User wants to change their ECL accounting period before submitting the returns") {
      ...
      thenIShouldBeOnThePageThatSaysX("Amount of Economic Crime Levy you need to pay")
    ...
    Scenario("User wants to change their ECL accounting period length before submitting the returns") {
      ...
      whenIClickOnTheChangeLinkToModifyMyAccountingPeriodLength()
    ...
    Scenario(
      "User wants to change their AML-regulated activity for the full financial year before submitting the returns"
    ) {
      Given("I am signed in to the return journey")
      givenIAmSignedInToTheReturnJourney()
    ...
    Scenario("Return submission for users who falls in the small band size (less than 10.2M)") {
      ...
      whenIEnter12MonthAccountingPeriodRevenueIsXThatFallsInTheSmallBandSize("10199999")

      Then("I should be on the page that says You do not need to pay the Economic Crime Levy (ECL)")
      thenIShouldBeOnThePageThatSaysX("You do not need to pay the Economic Crime Levy (ECL)")
    ...
    Scenario("User wants to change their UK revenue (greater than or equal to 10.2M) from amount due page") {
      ...
      When(
        "I click on the change link to edit my uk revenue from amount due page and select Yes for my AML-regulated activity for the full financial year"
      )
      whenIClickOnTheChangeLinkToEditMyUkRevenueFromAmountDuePageAndSelectXForMyAMLregulatedActivityForTheFullFinancialYear(
        "Yes"
      )
    ...
    Scenario("User wants to change the accounting period from amount due page for their UK revenue less than 10.2M") {
      ...
      When(
        "I click on the change link to edit my accounting period and select Yes for my AML-regulated activity for the full financial year"
      )
      whenIClickOnTheChangeLinkToEditMyAccountingPeriodAndSelectXForMyAMLregulatedActivityForTheFullFinancialYear("Yes")
    ...
    Scenario(
      "User is on the amount due page with content explaining how it was calculated [Expected content=Amount of Economic Crime Levy you need to pay]"
    ) {
      Given("I am signed in to the return journey")
      givenIAmSignedInToTheReturnJourney()
    ...
    Scenario(
      "User is on the amount due page with content explaining how it was calculated [Expected content=Your band size]"
    ) {
      Given("I am signed in to the return journey")
      givenIAmSignedInToTheReturnJourney()
      ...
      thenIShouldBeOnThePageThatSaysX("Your band size")

    }

    Scenario(
      "User is on the amount due page with content explaining how it was calculated [Expected content=How we worked this out]"
    ) {
      Given("I am signed in to the return journey")
      givenIAmSignedInToTheReturnJourney()
      ...
      thenIShouldBeOnThePageThatSaysX("How we worked this out")

    }

    Scenario(
      "User is on the amount due page with content explaining how it was calculated [Expected content=How the size bands affect what you need to pay]"
    ) {
      Given("I am signed in to the return journey")
      givenIAmSignedInToTheReturnJourney()
      ...
      thenIShouldBeOnThePageThatSaysX("How the size bands affect what you need to pay")

    }

    Scenario(
      "User is on the amount due page with content explaining how it was calculated [Expected content=What you need to do next]"
    ) {
      Given("I am signed in to the return journey")
      givenIAmSignedInToTheReturnJourney()
      ...
      thenIShouldBeOnThePageThatSaysX("What you need to do next")
    ...
    Scenario("User cancels amendments to the submitted economic crime levy return") {
      ...
      givenIAmSignedInToTheAccountJourneyWithMyECLReferenceAsX("XMECL0000000007")
    ...
    Scenario("User amends the submitted returns via ECL account dashboard") {
      ...
      andTheAmendedReturnInformationShouldDisplayUnderAmendedAnswersOnTheCheckYourAnswersPage(contactDetails)

      And("I should be on the page that says Economic Crime Levy return amendment requested")
      thenIShouldBeOnThePageThatSaysX("Economic Crime Levy return amendment requested")
    ...
    Scenario("User can save progress in the return submission journey and resume later") {
      ...
      andIReturnToTheServiceToCompleteTheTheReturnSubmission()
      ...
      andIShouldBeAbleToResumeTheSubmissionFromWhereILeftOff()
