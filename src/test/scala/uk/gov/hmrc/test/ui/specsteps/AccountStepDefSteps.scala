...
object AccountStepDefSteps {
  ...
  def thenTheInterestRowShouldDisplayThePartialInterestPaymentInformationUnderPaymentsYouOwe(arg: DataTable): Unit = {
...
//    }
  ...
  def thenTheInterestRowShouldDisplayTheFullyPaidInterestPaymentInformationUnderPaymentHistory(arg: DataTable): Unit = {
...
//  }
  ...
  def thenTheOverdueRowShouldDisplayTheOverduePaymentInformationUnderPaymentYouOwe(arg: DataTable): Unit = {
...
//  }
  ...
  def thenThePenaltyDataShouldNotBeDisplayed(arg: DataTable): Unit = {
