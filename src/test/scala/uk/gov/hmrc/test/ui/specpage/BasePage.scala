...
trait BasePage extends BrowserDriver with Matchers {
  ...
  def waitforTextBoxToBeAvailable(locator: By) =
    new WebDriverWait(Driver.instance, Duration.ofSeconds(20))
